    ...
    <div className={clsx('col col--4')}>
      <div className={styles.impactCard}>
        ...
        <div className={styles.cardHeader}>
          ...
          <div className={styles.metricBadge}>{metric}</div>
        </div>
...
const ImpactCardData = [
  {
    ...
    preview:
      'Transform economic theory into engaging behavioral simulations that reveal marketplace dynamics and platform governance challenges.',
  },
  {
    ...
    preview:
      'Real-time marketplace simulations revealing how trust mechanisms affect buyer-seller relationships in digital platforms.',
  },
  {
    ...
    preview:
      'One-click experiment replication enabling scientific rigor and accelerating platform governance research across institutions.',
  },
];
...
const SupporterData = [
  {
    ...
    amount: '$550,000',
    description:
      'Supporting our research into digital marketplace governance and misinformation prevention through behavioral experiments.',
        ...
        <div className='container'>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              ...
              institutional support, and technology partnerships with leading
              organizations committed to advancing digital platform governance.
            </p>
          </div>
